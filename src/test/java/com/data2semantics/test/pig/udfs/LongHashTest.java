...
public class LongHashTest extends PigTests {
	...
	public void md5Test() throws Exception {
		...
		assertOutput(test, "data_out", "(d9a82575758bb4978949dc0659205cc6)", "(9ec37f02fae0d8d6a7f4453a62272f1f)",
	...
	// {
	// PigTest test = createPigTest("test/pig/datafu/test/pig/hash/md5Base64Test.pig");
	//
